...
type EditHotelLogisticsPageProps = {
  params: Promise<{ id: string; logisticsId: string }>;
};

export default async function EditHotelLogisticsPage({
  params,
}: EditHotelLogisticsPageProps) {
      ...
      <div className="px-[var(--spacing-margin-mobile)]">
        <HotelLogisticsForm
          ...
          defaultValues={{
            ...
            name: detailString(details, "name"),
            address: detailString(details, "address"),
            checkIn: detailString(details, "checkIn"),
            checkOut: detailString(details, "checkOut"),
          }}
        />
      </div>
    </main>
